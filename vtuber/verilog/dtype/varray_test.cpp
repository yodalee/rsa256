...
TEST(TestVerilogArray, Unpack) {
                 ...
                 "F9ADDDCF'A45F1DFE");
  {
    ...
    unpack(a32_8, v256);
    EXPECT_EQ(a32_8[7].value(), 0xD1798A3C);
    EXPECT_EQ(a32_8[6].value(), 0x8326770B);
    EXPECT_EQ(a32_8[5].value(), 0x91643739);
    EXPECT_EQ(a32_8[4].value(), 0x7AB540E3);
    EXPECT_EQ(a32_8[3].value(), 0xD21345C7);
    EXPECT_EQ(a32_8[2].value(), 0x539C5996);
    EXPECT_EQ(a32_8[1].value(), 0xF9ADDDCF);
    EXPECT_EQ(a32_8[0].value(), 0xA45F1DFE);
  }
  {
    varray<vuint<64>, 4> a64_4;
    unpack(a64_4, v256);
    EXPECT_EQ(a64_4[3].value(), 0xD1798A3C8326770B);
    EXPECT_EQ(a64_4[2].value(), 0x916437397AB540E3);
    EXPECT_EQ(a64_4[1].value(), 0xD21345C7539C5996);
    EXPECT_EQ(a64_4[0].value(), 0xF9ADDDCFA45F1DFE);
  }
}
